...
module tb_fsa_fused_array;
  ...
  reg clk=0,rst_n=0,clear_i=0,clear_rows_i=0;
  ...
  reg causal_en_i=0,row_state_rd_en_i=0;
  ...
  reg pv_start_i=0,pv_seed_zero_i=1,pv_valid_i=0,pv_last_i=0;
  ...
  initial begin
    ...
    for(feature=0;feature<HEAD_DIM;feature=feature+1) begin
      ...
      pv_valid_i=1; pv_last_i=(feature==HEAD_DIM-1);
    end
    @(negedge clk); pv_valid_i=0; pv_last_i=0;
    wait(pv_done_o);
